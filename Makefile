##########################################################################
## Makefile for the Palabos example program rayleighBenard2D.
##
...
# Leading directory of the Palabos source coder
palabosRoot   = ../palabos
# Name of source files in current directory to compile and link with Palabos
projectFiles = singleSpecies_BGK_precipitation_pseudo_3D.cpp
...
#parallelCXX = /usr/local/packages/openmpi/1.5.4/bin/mpicxx
parallelCXX  = mpicxx
# General compiler flags (e.g. -Wall to turn on all warnings on g++)
compileFlags = -Wall -Wnon-virtual-dtor -std=c++11
